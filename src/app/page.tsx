...
export default function Home() {
      ...
      <section>
        <div className='h-[400px]   mt-36  w-full flex justify-center items-center  bg-[#F1F0FF]'>
           <div className='flex  flex-col md:flex-row gap-3 justify-center items-center '>
            <Image src={'/images/sofa.png'}  width={558} height={550}  alt='sofa'  className='lg:h-[400px] lg:w-[400px] md:h-[250px] md:w-[250px] md:block  h-[200px] w-[200px]  hidden' />
  ...
  <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center gap-4">
    ...
    <button
      className="p-7 h-10 w-[150px] flex justify-center items-center text-white bg-[#FB2E86]"
    >
      Shop Now
    </button>
  </div>
